...
namespace WIDE.View.Controls
{
    internal static class AssemblerEditorInitializer
    {
        ...
        {
            s.SetSelectionBackColor(true, Styles.ColorSelection);
        }
        ...
        private static void Syntax(Scintilla s)
        {
            ...
            s.StyleResetDefault();
            s.Styles[Style.Default].Font = Styles.FontMonospace(1).FontFamily.Name;
            s.Styles[Style.Default].Size = 10;
            s.Styles[Style.Default].BackColor = Styles.ColorCodeBackground;
            s.Styles[Style.Default].ForeColor = Styles.ColorCodeFont;
            s.StyleClearAll();
            ...
            s.Styles[Style.Asm.Identifier].ForeColor = Styles.ColorCodeInstruction;
            s.Styles[Style.Asm.Comment].ForeColor = Styles.ColorCodeComment;
            //s.Styles[Style.Asm.
