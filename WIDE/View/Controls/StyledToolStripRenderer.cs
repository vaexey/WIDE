...
{
    public class StyledToolStripRenderer : ToolStripProfessionalRenderer
    {
        public StyledToolStripRenderer() : base(new StyledColorTable()) { }
    }

    public class StyledColorTable : ProfessionalColorTable
    {
        /// <summary>
